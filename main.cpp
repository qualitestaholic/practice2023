...
void sendEmailWithAttachments(const string& recipient, const string& subject, const string& body, const string& folderPath)
{
    ...
    string smtpServer = "smtp.gmail.com"; // ”кажите адрес SMTP-сервера в соответствии с вашими настройками.
    string senderEmail = "gdsher42@gmail.com"; // ”кажите вашу электронную почту
    string senderPassword = "uiucihblmigureno"; // ”кажите ваш пароль
